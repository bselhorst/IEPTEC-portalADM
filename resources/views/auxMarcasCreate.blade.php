...
@section('page-title')
<span class="font-weight-semibold">Marcas</span> - Cadastrar
@endsection
...
<div class="card">
    <div class="card-header header-elements-inline">
        <h5 class="card-title">Cadastrar Marcas</h5>
    ...
    <div class="card-body">
        <form class="form-validate-jquery" method="POST" action="{{ route('marcas.store') }}">
            @csrf
            <fieldset class="mb-3">
                <legend class="text-uppercase font-size-sm font-weight-bold">Dados do Marca</legend>
                <div class="form-group row">
                    <label class="col-form-label col-lg-3">Nome <span class="text-danger">*</span></label>
                    <div class="col-lg-9">
                        <input type="text" name="marca" class="form-control" required placeholder="Nome da marca">
                    </div>
                </div>
            </fieldset>
