...
<a href="#" class="breadcrumb-item active"><i class="icon-history mr-2"></i> histórico de Retiradas</a>
@endsection
                        ...
                        <tbody>
                            ...
                            @foreach($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="font-weight-semibold">{{ $item->solicitante }}</div>
                                    </td>
                                    <td>
                                        <div class="font-weight-semibold">{{ $item->usuario }}</div>
                                    </td>
                                    <td>
                                        ...
                                        <div class="list-icons">
                                            <div class="list-icons-item dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <form method="POST" action="{{ route('almoxarifado.cancelarRetirada', $item->codigo) }}" onsubmit="return confirm('Deseja cancelar esse registro?')">
                                                        @csrf
                                                        @method('PATCH')
                                                        <button class="dropdown-item"><i class="icon-cross2 text-danger"></i> Cancelar Retirada</button>
                                                    </form>
