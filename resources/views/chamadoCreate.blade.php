...
@section('page-title')
<span class="font-weight-semibold">Chamados</span> - Cadastrar
@endsection
...
<div class="card">
    ...
    <div class="card-body">
        <form class="form-validate-jquery" method="POST" action="{{ route('chamados.store') }}">
            @csrf
            <fieldset class="mb-3">
                ...
                <!--<div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="titulo" class="form-control" required placeholder="Título do chamado">
                    </div>
                </div>-->
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="solicitante" class="form-control" required placeholder="Nome do Solicitante">
                    </div>
                </div>
				<div class="form-group row">
					<label class="col-form-label col-lg-3">Descrição <span class="text-danger">*</span></label>
					<div class="col-lg-9">
						<textarea rows="5" cols="5" name="descricao" class="form-control" required placeholder="Descrição do chamado"></textarea>
					</div>
                </div>
                <div class="form-group row">
